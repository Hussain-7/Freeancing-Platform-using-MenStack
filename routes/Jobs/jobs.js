...
router.get("/:jobID/getproposal", middleware.isLoggedIn, async (req, res) => {
...
router.post("/updateviews/:id", middleware.isLoggedIn, function (req, res) {
    Job.updateOne({ _id:req.params.id},{ $inc: { 'jobdetail.views': 1 }},function(err,updateditem){ 
        console.log("in update view function!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
        res.send("Success"); 
    })
})
